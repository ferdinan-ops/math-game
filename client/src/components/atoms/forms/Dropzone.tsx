  ...
  return (
    <div className="flex w-full flex-col gap-1.5 lg:gap-2.5">
      {files?.length > 0 ? (
        ...
        <div
          className="flex flex-col items-center justify-center gap-5 rounded-lg border-2 border-dashed border-primary/25 py-5 pl-8 pr-6 dark:border-white/25 md:flex-row md:gap-6"
          {...getRootProps()}
          ref={dropzoneRef}
        >
